...
public final class GwentCards {
    ...
    private GwentCards()
    {
        ...
        cards[i] = new GwentCard(i++, "Tibor Eggebracht", 10, AttackRow.LongRange, true, CardBehaviour.None);
        ...
        cards[i] = new GwentCard(i++, "Nilfgaardzki Łucznik", 10, AttackRow.LongRange, false, CardBehaviour.None);
        ...
        cards[i] = new GwentCard(i++, "Assier var Anahid", 6, AttackRow.LongRange, false, CardBehaviour.None);
        ...
        cards[i] = new GwentCard(i++, "Fringilla Vigo", 6, AttackRow.LongRange, false, CardBehaviour.None);
        cards[i] = new GwentCard(i++, "Renuald aep Matsen", 5, AttackRow.LongRange, false, CardBehaviour.None);
        ...
        cards[i] = new GwentCard(i++, "Vanhemar", 4, AttackRow.LongRange, false, CardBehaviour.None);
        cards[i] = new GwentCard(i++, "Rainfarn", 4, AttackRow.CloseCombat, false, CardBehaviour.None);
        cards[i] = new GwentCard(i++, "Cynthia", 4, AttackRow.LongRange, false, CardBehaviour.None);
        ...
        cards[i] = new GwentCard(i++, "Puttkammer", 3, AttackRow.LongRange, false, CardBehaviour.None);
        cards[i] = new GwentCard(i++, "Morteisen", 3, AttackRow.CloseCombat, false, CardBehaviour.None);
        cards[i] = new GwentCard(i++, "Albrich", 2, AttackRow.LongRange, false, CardBehaviour.None);
        cards[i] = new GwentCard(i++, "Sweers", 2, AttackRow.LongRange, false, CardBehaviour.None);
        ...
        cards[i] = new GwentCard(i++, "Wsparcie Łuczników", 1, AttackRow.LongRange, false, CardBehaviour.Medyk);
        ...
        cards[i] = new GwentCard(i++, "Filippa Eilhart", 10, AttackRow.LongRange, true, CardBehaviour.None);
        ...
        cards[i] = new GwentCard(i++, "Detmold", 6, AttackRow.LongRange, false, CardBehaviour.None);
        ...
        cards[i] = new GwentCard(i++, "Keira Metz", 5, AttackRow.LongRange, false, CardBehaviour.None);
        cards[i] = new GwentCard(i++, "Sheala de Tancarville", 5, AttackRow.LongRange, false, CardBehaviour.None);
        cards[i] = new GwentCard(i++, "Książę Stennis", 5, AttackRow.CloseCombat, false, CardBehaviour.Szpieg);
        cards[i] = new GwentCard(i++, "Rębacze z Crinfrid", 5, AttackRow.LongRange, false, CardBehaviour.Wiez);
        cards[i] = new GwentCard(i++, "Medyczka Burej Chorągwi", 5, AttackRow.Siege, false, CardBehaviour.Medyk);
        cards[i] = new GwentCard(i++, "Sabrina Glevissig", 4, AttackRow.LongRange, false, CardBehaviour.None);
        cards[i] = new GwentCard(i++, "Sheldon Skaggs", 4, AttackRow.LongRange, false, CardBehaviour.None);
